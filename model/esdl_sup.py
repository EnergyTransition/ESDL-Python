...
#
# Generated Sat Oct 13 17:09:51 2018 by generateDS.py version 2.29.24.
...
class EnergySystem(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            self.instance or
            self.potentials is not None or
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='esdl:', name_='EnergySystem', fromsubclass_=False, pretty_print=True):
        ...
        if self.potentials is not None:
            self.potentials.export(outfile, level, namespaceprefix_, name_='potentials', pretty_print=pretty_print)
...
class Potentials(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, Potentials)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if Potentials.subclass:
            return Potentials.subclass(*args_, **kwargs_)
        else:
    ...
    def export(self, outfile, level, namespaceprefix_='esdl:', name_='Potentials', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='Potentials')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_='esdl:', name_='Potentials', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='esdl:', name_='Potentials'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='esdl:', name_='Potentials', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
